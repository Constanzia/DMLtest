...
if(r<vmin){vertex(cir1.x+r*cos(PI/4.0),cir1.y-r*sin(PI/4.0));}
else{vertex(cir1.x+r*cos(PI/8.0),cir1.y-r*sin(PI/8.0));}
                 
if(r<vmin){vertex(cir11.x-r*cos(PI/4.0),cir11.y+r*sin(PI/4.0));}else{
  vertex(cir11.x-r*cos(PI/8.0),cir11.y+r*sin(PI/8.0));
}
                 
if(r<vmin){vertex(cir11.x+r*cos(PI/12.0),cir11.y+r*sin(PI/12.0));   }else{
vertex(cir11.x+r,cir11.y);}

                 
  if(r<vmin){vertex(cir4.x-r*cos(PI/12.0),cir4.y-r*sin(PI/12.0));   }else{
vertex(cir4.x-r,cir4.y);
  }

                 
if(r<vmin){vertex(cir4.x+r*cos(PI/12.0),cir4.y+r*sin(PI/12.0));}else if(r>vmax){vertex(cir4.x+r*cos(PI/3.0),cir4.y+r*sin(PI/3.0));}else
{vertex(cir4.x+r*cos(PI/4.0),cir4.y+r*sin(PI/4.0));}
                 
if(r<vmin){vertex(cir8.x-r*cos(PI/12.0),cir8.y-r*sin(PI/12.0));}else if(r>vmax)
...
else{vertex(cir8.x-r*sin(PI/4.0),cir8.y+r*cos(PI/4.0));}
...
if(r<vmin){ vertex(cir15.x-r*sin(PI/12.0),cir15.y+r*cos(PI/12.0));}else if(r>vmax){
vertex(cir15.x-r*sin(PI/3.0),cir15.y+r*cos(PI/3.0));
}else{vertex(cir15.x-r*sin(PI/4.0),cir15.y+r*cos(PI/4.0));
}
                 
if(r<vmin){ vertex(cir14.x+r*sin(PI/12.0),cir14.y-r*cos(PI/12.0));}else if(r>vmax){
vertex(cir14.x+r*sin(PI/3.0),cir14.y-r*cos(PI/3.0));
}else{vertex(cir14.x+r*sin(PI/4.0),cir14.y-r*cos(PI/4.0));
}
...
if(r<vmin){ vertex(cir13.x+r*sin(PI/12.0),cir13.y+r*cos(PI/12.0));}else if(r>vmax){
vertex(cir13.x+r*sin(PI/3.0),cir13.y+r*cos(PI/3.0));
}else{vertex(cir13.x+r*sin(PI/4.0),cir13.y+r*cos(PI/4.0));
}
                 
if(r<vmin){ vertex(cir13.x-r*sin(PI/8.0),cir13.y-r*cos(PI/8.0));}else if(r>vmax){
vertex(cir13.x,cir13.y-r);
}else{vertex(cir13.x-r*sin(PI/12.0),cir13.y-r*cos(PI/12.0));
}
if(r<vmin){ vertex(cir10.x+r*sin(PI/8.0),cir10.y+r*cos(PI/8.0));}else if(r>vmax){
vertex(cir10.x,cir10.y+r);
}else{vertex(cir10.x+r*sin(PI/12.0),cir10.y+r*cos(PI/12.0));
} 
if(r<vmin){ vertex(cir10.x+r*sin(PI/8.0),cir10.y-r*cos(PI/8.0));}else if(r>vmax){
vertex(cir10.x,cir10.y-r);
}else{vertex(cir10.x+r*sin(PI/12.0),cir10.y-r*cos(PI/12.0));
} 
if(r<vmin){ vertex(cir5.x-r*sin(PI/8.0),cir5.y+r*cos(PI/8.0));}else if(r>vmax){
vertex(cir5.x,cir5.y+r);
}else{vertex(cir5.x-r*sin(PI/12.0),cir5.y+r*cos(PI/12.0));
}
endShape(CLOSE);
                }

function refill2(){ empty(cir8.x,cir8.y,2*r);
  empty(cir11.x,cir11.y,2*r);  
empty(cir14.x,cir14.y,2*r);
empty(cir10.x,cir10.y,2*r); }
